...
return Object.defineProperty(a,"__esModule",{value:!0}),a}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("c2jweb/app").default.create({name:"c2jweb",version:"0.0.0+2765f7d1"})
