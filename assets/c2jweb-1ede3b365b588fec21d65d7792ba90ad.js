...
return Object.defineProperty(a,"__esModule",{value:!0}),a}catch(i){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("c2jweb/app").default.create({name:"c2jweb",version:"0.0.0+a6efdb2a"})
