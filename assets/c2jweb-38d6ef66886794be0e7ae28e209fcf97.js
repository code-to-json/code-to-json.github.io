...
var t=Ember.HTMLBars.template({id:"l8vss1Ko",block:'{"symbols":[],"statements":[[7,"h1",true],[8],[0,"Hello Ember!!"],[9],[0,"\\n"],[0,"\\n"],[1,[22,"outlet"],false]],"hasEval":false}',meta:{moduleName:"c2jweb/templates/application.hbs"}})
...
return Object.defineProperty(a,"__esModule",{value:!0}),a}catch(i){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("c2jweb/app").default.create({name:"c2jweb",version:"0.0.0+5b22dd95"})
